...
const dictionaries: Record<Language, Dictionary> = {
  en: {
    ...
    purchase: {
      ...
      buyDigital: 'Purchase Digital — $9.99',
    ...
    publisherHero: {
      est: 'Est. 2025',
      headlinePart1: "We Do Not Distribute Books.",
    ...
    dispatch: {
      ...
      text1Part1: 'Light of Eolles is a sovereign voice forged in the fire of silence. She carries the ancestral roar of bold women and the sacred stillness of divine downloads. A soul appointed not by algorithms, but by assignment.',
      text1Part2: '',
      text1Part3: '',
    ...
    remnant: {
      ...
      footerText: 'The Throne Room Awaits',
    },
    mandate: {
      label: 'The Mission',
      headlinePart1: 'We are not here to fill shelves.',
      headlinePart2: 'We are here to build altars in the shape of words.',
    ...
    archive: {
      ...
      catalog: [
        { title: 'The Crowded Bed & The Empty Throne', author: 'Light of Eolles', description: 'A prophetic gift for women ready to reclaim their crown.', status: 'Available Now', viewBook: 'View Book' },
      ],
      comingSoon: 'More Scrolls Coming Soon',
    },
    gate: {
      label: 'Submissions',
      headline: 'The Gate',
    ...
    ledger: {
      ...
      copyright: 'Throne Light Publishing. All Rights Reserved.',
      slogan: 'Sovereignty in every word.',
    },
    footer: {
      taglinePart1: "We do not distribute books.",
      taglinePart2: "We distribute light.",
      constellation: "The Constellation",
      connect: "Connect",
      rights: "Throne Light Publishing. All Rights Reserved.",
      slogan: "Sovereignty in every word.",
    },
  },
  fr: {
    ...
    confrontation: {
      ...
      text1Part1: 'Pas "répond-il aux SMS". Est-ce qu\'il ',
    ...
    dispatch: {
      ...
      text1Part1: 'Lumière d\'Eolles est une voix souveraine forgée dans le feu du silence. Elle porte le rugissement ancestral des femmes audacieuses et le calme sacré des téléchargements divins. Une âme nommée non par des algorithmes, mais par assignation.',
      text1Part2: '',
      text1Part3: '',
    ...
    gathering: {
      ...
      requestedCitiesDesc: 'Cliquez sur 👍 si vous souhaitez qu\'Eolles visite cette ville.',
    ...
    archive: {
      ...
      headline: 'L\'Archive',
      catalog: [
        { title: 'Le Lit Bondé & Le Trône Vide', author: 'Lumière d\'Eolles', description: 'Un parchemin prophétique pour les femmes prêtes à réclamer leur couronne.', status: 'Disponible Maintenant', viewBook: 'Voir le Livre' },
      ],
  ...
  es: {
    ...
    purchase: {
      ...
      buyDigital: 'Comprar Digital — $9.99',
  ...
  it: {
    ...
    purchase: {
      ...
      buyDigital: 'Acquista Digitale — $9.99',
    ...
    dispatch: {
      ...
      text1Part1: 'Luce di Eolles è una voce sovrana forgiata nel fuoco del silenzio. Porta il ruggito ancestrale di donne audaci e il sacro silenzio dei download divini. Un\'anima nominata non da algoritmi, ma per assegnazione.',
      text1Part2: '',
      text1Part3: '',
    ...
    archive: {
      ...
      headline: 'L\'Archivio',
      catalog: [
        { title: 'Il Letto Affollato e Il Trono Vuoto', author: 'Luce di Eolles', description: 'Una pergamena profetica per le donne pronte a reclamare la loro corona.', status: 'Disponibile Ora', viewBook: 'Vedi Libro' },
      ],
  ...
  de: {
    ...
    dispatch: {
      ...
      text1Part1: 'Licht von Eolles ist eine souveräne Stimme, die im Feuer der Stille geschmiedet wurde. Sie trägt das angestammte Gebrüll mutiger Frauen und die heilige Stille göttlicher Downloads. Eine Seele, die nicht durch Algorithmen, sondern durch Auftrag ernannt wurde.',
      text1Part2: '',
      text1Part3: '',
    ...
    archive: {
      ...
      headline: 'Das Archiv',
      catalog: [
        { title: 'Das Überfüllte Bett & Der Leere Thron', author: 'Licht von Eolles', description: 'Eine prophetische Schriftrolle für Frauen, die bereit sind, ihre Krone zurückzufordern.', status: 'Jetzt Erhältlich', viewBook: 'Buch Ansehen' },
      ],
  ...
  yo: {
    ...
    dispatch: {
      label: 'Orisun',
      headline: 'Ilana Ọrun',
      text1Part1: 'Imọlẹ ti Eolles jẹ ohun ọba-ara ti a ṣe ninu ina ti idakẹjẹ. O gbe ariwo ti awọn obinrin onigboya ati idakẹjẹ mimọ ti awọn gbigba lati ọrun wá. Ọkan ti a yan kii ṣe nipasẹ awọn algoridimu, ṣugbọn nipasẹ iṣẹ-ṣiṣe.',
      text1Part2: '',
      text1Part3: '',
    ...
    archive: {
      ...
      headline: 'Ile-ipamọ',
      catalog: [
        { title: 'Ibùsùn Tí Ó Kún & Ìtẹ́ Tí Ó Òfo', author: 'Imọlẹ ti Eolles', description: 'Iwe-kika asọtẹlẹ fun awọn obinrin ti o ṣetan lati gba ade wọn pada.', status: 'Wa Bayi', viewBook: 'Wo Iwe' },
      ],
