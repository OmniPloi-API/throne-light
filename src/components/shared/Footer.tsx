...
const DOWNLOAD_URLS = {
  mac: 'https://github.com/OmniPloi-API/throne-light/releases/download/v1.0.4/Throne-Light-Reader-macOS-v1.0.4.dmg',
          ...
          >
            ...
            >
              ...
              <div className="mt-6 space-y-3">
                ...
                {/* Windows Download */}
                <button
                  onClick={() => window.open('/downloads/ThroneLight-Reader-Windows.exe', '_blank')}
                  className="w-full flex items-center gap-4 p-4 rounded-xl border border-parchment/20 hover:border-parchment/40 hover:bg-parchment/5 transition-all"
                >
